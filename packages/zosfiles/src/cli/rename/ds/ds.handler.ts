...
import { Rename } from "../../../api/methods/rename";
...
export default class DSHandler extends ZosFilesBaseHandler {
    public async processWithSession(
        ...
        return Rename.dataSet(session, commandParameters.arguments.beforeDataSetName, commandParameters.arguments.afterDataSetName);
    }
}
